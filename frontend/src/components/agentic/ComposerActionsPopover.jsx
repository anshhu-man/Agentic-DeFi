    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      ...
      <PopoverContent className="w-96 p-0" align="start" side="top">
        {!showMore ? (
          ...
          <div className="p-3">
            <div className="space-y-1">
              {mainActions.map((action, index) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-3 w-full p-2 text-sm text-left hover:bg-muted dark:hover:bg-gray-800 rounded-lg"
                  >
              ...
              <button
                ...
                className="flex items-center gap-3 w-full p-2 text-sm text-left hover:bg-muted dark:hover:bg-gray-800 rounded-lg border border-border dark:border-gray-700"
              >
          ...
          <div className="flex">
            <div className="flex-1 p-3 border-r border-border dark:border-gray-800">
              <div className="space-y-1">
                {mainActions.map((action, index) => {
                  const IconComponent = action.icon
                  return (
