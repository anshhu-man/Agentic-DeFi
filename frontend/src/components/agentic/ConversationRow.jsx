...
export default function ConversationRow({ data, active, onSelect, onTogglePin, showMeta }) {
  ...
  return (
    <div className="group relative">
      ...
      <div className="pointer-events-none absolute left-[calc(100%+6px)] top-1 hidden w-64 rounded-xl border border-border bg-card p-3 text-xs text-foreground shadow-lg md:group-hover:block">
