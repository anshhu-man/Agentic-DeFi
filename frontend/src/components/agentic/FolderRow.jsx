            ...
            <AnimatePresence>
              {showMenu && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-1 w-32 rounded-lg border border-border bg-card py-1 shadow-lg dark:border-gray-800 dark:bg-gray-900 z-[100]"
                >
                  <button
                  ...
                  <button
                    ...
                    className="w-full px-3 py-1.5 text-left text-xs text-red-600 hover:bg-muted dark:hover:bg-gray-800"
                  >
                    Delete
                  </button>
                </motion.div>
