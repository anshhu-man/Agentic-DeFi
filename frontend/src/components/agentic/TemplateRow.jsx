...
export default function TemplateRow({ template, onUseTemplate, onEditTemplate, onRenameTemplate, onDeleteTemplate }) {
  ...
  return (
    <div className="group">
      <div className="flex items-center justify-between rounded-lg px-2 py-2 text-sm hover:bg-muted dark:hover:bg-gray-800">
        <button
          onClick={handleUse}
            ...
            <AnimatePresence>
              {showMenu && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-1 w-36 rounded-lg border border-border bg-card py-1 shadow-lg dark:border-gray-800 dark:bg-gray-900 z-[100]"
                >
                  <button
                    onClick={handleUse}
                    className="w-full px-3 py-1.5 text-left text-xs hover:bg-muted dark:hover:bg-gray-800 flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full px-3 py-1.5 text-left text-xs hover:bg-muted dark:hover:bg-gray-800"
                  >
                    Rename
                  </button>
                  <button
                    onClick={handleDelete}
                    className="w-full px-3 py-1.5 text-left text-xs text-red-600 hover:bg-muted dark:hover:bg-gray-800 flex items-center gap-2"
                  >
