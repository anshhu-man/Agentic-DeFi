...
-- Insert a demo admin user (for testing purposes)
-- Note: This creates a user in the profiles table, not auth.users
-- The actual auth user needs to be created through the auth flow
INSERT INTO public.profiles (user_id, display_name, bio, total_portfolio_value, risk_tolerance)
VALUES (
